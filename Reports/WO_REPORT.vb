...
Imports System.IO
Public Class WO_REPORT
    Dim gconnection As New GlobalClass

    Private Sub WO_REPORT_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
       
        If e.KeyCode = Keys.F6 Then
            Call Me.Cmd_Clear_Click(Cmd_Clear, e)
            Exit Sub
        End If
        ...
        End If
    End Sub
    Private Sub WO_REPORT_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub Cmd_View_Click(sender As Object, e As EventArgs) Handles Cmd_View.Click
        Try
            ...
            Dim r As New Cry_WOREPORT
            sqlstring = " SELECT * FROM VIEW_WO_REPORT WHERE WOBDATE "
            sqlstring = sqlstring & " BETWEEN '" & Format(DTP_FROMDATE.Value, "dd/MMM/yyyy") & "' and '" & Format(DTP_TODATE.Value, "dd/MMM/yyyy") & "' "
            sqlstring = sqlstring & " ORDER BY WOBDETAILS, WOBDATE"

            gconnection.getDataSet(sqlstring, "VIEW_WO_REPORT")
            If gdataset.Tables("VIEW_WO_REPORT").Rows.Count > 0 Then
                
                rViewer.ssql = sqlstring
                rViewer.Report = r
                rViewer.TableName = "VIEW_WO_REPORT"
