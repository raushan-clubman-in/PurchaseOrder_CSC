...
#End Region
    ...
    Public Sub FillCompanyinfo()
        ...
        Try
            ...
            sqlstring = sqlstring & " ISNULL(City,'') AS City,ISNULL(State,'') AS State,ISNULL(Pincode,'') AS Pincode,ISNULL(Datafile,'') AS Datafile, ISNULL (AUDITFLG,'N') AS AUDITFLG FROM ClubMaster where datafile='" & gDatabase & "' "
