...
Public Class Crys_wo_indent
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SmartCard.Crys_wo_indent.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrys_wo_indent
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Crys_wo_indent = New Crys_wo_indent()
        rpt.Site = Me.Site
        Return rpt
    End Function
